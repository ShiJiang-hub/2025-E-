...
{
    ui->screen_pi_del = true;
    ui->screen_device_del = true;
    ui->screen_pid_del = true;
    ui->screen_center_del = true;
    ui->screen_msg_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    init_keyboard(ui);
    setup_scr_screen_center(ui);
    lv_scr_load(ui->screen_center);
}
